 ...
 * Navigation Employer.
 *
 * This template can be overridden by copying it to yourtheme/job-listings/member/navigation-employer.php.
 *
...
<?php
do_action( 'jlt_before_member_navigation' );
?>
...
<?php do_action( 'jlt_after_member_navigation' ); ?>